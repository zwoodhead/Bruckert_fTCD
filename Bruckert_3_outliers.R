#########################################################################################
# Bruckert Script 3: Outliers
#########################################################################################
# This script runs after Bruckert Script 2, which calculates LI values for all participants.
...
resultsfile <- paste0(rootdir,'Bruckert_',task,"_results.csv") # File lists analysis results
